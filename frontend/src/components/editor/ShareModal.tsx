...
export const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative bg-[#121214] border border-zinc-800 rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden">
        {/* Header */}
        ...
        <div className="p-6 flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  value={shareLink}
                  readOnly
                  className="flex-1 bg-zinc-900 border border-zinc-800 rounded-lg px-3 py-2 text-xs text-zinc-300 font-mono"
                />
                <button
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-zinc-900 border border-zinc-800 focus:border-violet-500 rounded-lg px-3 py-2 text-xs text-zinc-200 outline-none placeholder:text-zinc-600"
              />
              <button
          ...
          <div className="flex gap-2 pt-2">
            <button
              onClick={handleDownloadPreview}
              className="flex-1 flex items-center justify-center gap-2 py-2.5 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-lg text-xs font-semibold text-zinc-300 transition-colors cursor-pointer"
            >
